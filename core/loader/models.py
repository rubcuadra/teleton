...
class Estado(models.Model):
    ...
    def SorianaParser(estadoSoriana):
        ...
        if estadoBanamex in SORIANA_PARSER: return SORIANA_PARSER[estadoSoriana]
        return estadoSoriana #it is already ok
